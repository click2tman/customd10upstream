 ...
 */
function tpisent_edu_form_system_theme_settings_alter(&$form, &$form_state) {
  $form['#attached']['library'][] = 'tpisent_edu/gavias-edupia-admin';  
  ...
  $form['general']['course_search_action'] = array(
    '#type' => 'textfield',
    '#title' => t('Link Action Course Search Form (e.g: courses)'),
    '#default_value' => theme_get_setting('course_search_action')
  );
