<?php
function tpisent_edu_base_url(){
  global $base_url;
  $theme_path = \Drupal::service('extension.list.theme')->getPath('tpisent_edu');
  return $base_url . '/' . $theme_path . '/';
}
global $gva_node_index;
function tpisent_edu_preprocess_node(&$variables) {
  global $gva_node_index;
  ...
  $variables['theme_uri'] = base_path() . \Drupal::service('extension.list.theme')->getPath('tpisent_edu');
}

function tpisent_edu_preprocess_node__portfolio(&$variables){
  $node = $variables['node'];
...
function tpisent_edu_preprocess_node__event(&$variables){
  $node = $variables['node'];
  $event_date = array();
...
function tpisent_edu_preprocess_breadcrumb(&$variables){
